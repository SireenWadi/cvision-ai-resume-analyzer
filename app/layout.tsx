...
export const metadata: Metadata = {
  title: 'CVision AI — Resume Intelligence Platform',
  description: 'Analyze your resume with AI. Get ATS score, keyword analysis, and personalized improvement suggestions.',
}
